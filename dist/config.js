...
function requiredEnv(name) {
    ...
    if (!value)
        throw new Error(`${name} is required. Add it to .env or the deployment environment.`);
    return value;
}
...
export function readBotConfig() {
    ...
    return {
        ...
        botFallbackReply: optionalEnv("BOT_FALLBACK_REPLY", "Thanks for your question. I do not have a saved answer for that yet. Please leave your contact details and our team will reply."),
        botResponderUrl,
