import { sendTelegramMessage } from "./account-client.js";
...
async function main() {
    ...
    if (!token || !accountId || !recipient || !message) {
        throw new Error('Usage: npm run send -- --token TOKEN --account-id ACCOUNT_ID --recipient @username --message "Hello"');
    }
